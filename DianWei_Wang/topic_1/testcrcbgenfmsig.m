...
% Generate the signal
sigVec = crcbgenfmsig(timeVec,A,[f0, b, f1]);
...
% three coefficients [f0, b, f1] that parametrize the phase of the signal:
% f0*t + b*cos(2*pi*fi*t). 

%Soumya D. Mohanty, May 2018
%DianWei Wang modified, Feb 2022

phaseVec = fmCoefs(1)*dataX + fmCoefs(2)*cos(2*pi*fmCoefs(3)*dataX);
